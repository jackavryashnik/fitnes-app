...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const favoritesContainerBlock = document.querySelector('.favorites-contanier-block');
    ...
    function paginate() {
        ...
        const itemsPerPage = (window.innerWidth <= 767 && isFavoritesListVisible()) ? 6 : favoritesList.children.length;
        ...
        const totalPages = Math.ceil(favoritesList.children.length / itemsPerPage);
        let currentPage = 1;
        ...
        function showPage(page) {
            ...
            for (let i = startIndex; i < endIndex && i < favoritesList.children.length; i++) {
                favoritesList.children[i].style.display = 'block';
            }
        }
